...
export default function CreateHealthPackageWithServices() {
  const [formData, setFormData] = useState({
    packageName: "",
    packagePrice: "100000", // Mặc định 100,000 VND
    packageImage: "",
    description: "",
  ...
  const BASE_PACKAGE_PRICE = 100000 // Giá cơ bản của gói khám
  ...
  const fetchAvailableServices = async () => {
    try {
      ...
      console.log("Available services:", availableServices.length) // Debug log
      ...
      if (err.response?.status === 404) {
        setError("API endpoint không tồn tại. Vui lòng kiểm tra đường dẫn API.")
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 py-8">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-blue-100 mt-2">Tạo gói khám sức khỏe với các dịch vụ cận lâm sàng</p>
        </div>
      </div>
              ...
              <div className="p-6">
                ...
                {servicesLoading ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <h4 className="text-lg font-semibold text-gray-900 mb-2">Không thể tải dịch vụ</h4>
