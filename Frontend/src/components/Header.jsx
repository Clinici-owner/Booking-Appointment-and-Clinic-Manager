      ...
      <nav className=" px-18 bg-white shadow-lg rounded-b-xl px-4 py-3 flex items-center justify-between mb-4">
        ...
        <ul className="hidden md:flex items-center gap-6 font-semibold text-base">
          <li>
            <Link
              to="/"
              className={`w-[140px] text-center px-3 py-2 rounded-full font-semibold cursor-pointer transition duration-300 hover:shadow-md ${isActive("/")
          ...
          <li>
            <Link
              to="/aboutus"
              className={`w-[140px] text-center px-3 py-2 rounded-full font-semibold cursor-pointer transition duration-300 hover:shadow-md ${isActive("/aboutus")
                  ? "text-white bg-custom-blue shadow-md"
                  : "text-black hover:bg-custom-bluehover"
                }`}
            >
          ...
          <li>
            <Link
              to="/specialties"
              className={`w-[140px] text-center px-3 py-2 rounded-full font-semibold cursor-pointer transition duration-300 hover:shadow-md ${isActive("/specialties")
                  ? "text-white bg-custom-blue shadow-md"
                  : "text-black hover:bg-custom-bluehover"
                }`}
            >
          ...
          <li>
            <Link
              to="/health-packages"
              className={`w-[140px] text-center px-3 py-2 rounded-full font-semibold cursor-pointer transition duration-300 hover:shadow-md ${isActive("/health-packages")
                  ? "text-white bg-custom-blue shadow-md"
                  : "text-black hover:bg-custom-bluehover"
                }`}
            >
          ...
          <li>
            <Link
              to="/MyProcess"
              className={`w-[140px] text-center px-3 py-2 rounded-full font-semibold cursor-pointer transition duration-300 hover:shadow-md ${isActive("/MyProcess")
                  ? "text-white bg-custom-blue shadow-md"
                  : "text-black hover:bg-custom-bluehover"
                }`}
            >
